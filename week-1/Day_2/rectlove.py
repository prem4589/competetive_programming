...
def check1(point1, length1, point2, length2):    
    z1 = max(point1, point2)
    a10 = min(point1 + length1, point2 + length2)
    if z1 >= a10:
        return (None, None)  
    overlap_length = a10 - z1
    return (z1, overlap_length)
def check2(rect1, rect2):
    
    startPoint_x, overlapWidth  = check1(rect1['left_x'],
                                                         rect1['width'],
                                                         rect2['left_x'],
                                                         rect2['width'])
    startPoint_y, overlapHeight = check1(rect1['bottom_y'],
                                                         rect1['height'],
                                                         rect2['bottom_y'],
                                                         rect2['height'])    
